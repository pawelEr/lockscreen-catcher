...
export class WelcomeController {
    ...
    public getScan = (req: Request, res: Response): void => {
        ...
        let fileEntrys: FileEntry[] = files.map((file) => { return new FileEntry(file, this.imagesPath, '/upload'); })
        fileEntrys.forEach((fileEntry) => { copyFileSync(fileEntry.inputPath, "." + fileEntry.uploadedPath) });
